# zkVM Benchmarks by Stackr

**Summary:** A not so succinct comparison (_with numbers_) between zkVMs and their WASM compatibility (Q4 2024 edition).

**Team Members:** Kautuk Kundan ([GitHub](https://github.com/kautukkundan), [Twitter](https://x.com/kautukkundan)), Prudhvi Rampey ([GitHub](https://github.com/0xRampey), [Twitter](https://x.com/0xRampey)) and Aashutosh Rathi ([GitHub](https://github.com/aashutoshrathi), [Twitter](https://x.com/AashutoshRathi))

**Repo Link:** [@stackrlabs/succinct-residency](https://github.com/stackrlabs/succinct-residency-exps/)

**Additional Resources:** [Slides](https://docs.google.com/presentation/d/1crZZhQaNVXXfk49cOoEMu3oPZDxsVh-hP7IFeb-PTbY/edit)
...
- Which ones are ready for production use or what is missing in them?
...
And we chose few algorithms to benchmark:
